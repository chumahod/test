...
def huntChest():
    ...
    for i in range(10):
        try:
            ...
            logging.info("close btn find")
            logging.info("mouse move to point")
            p.moveTo(602, 120, 0.5)
            p.click(interval=0.3)
            p.moveTo(622, 198, 0.3)
            p.click()
            p.moveTo(610, 265, 0.3)
            p.click()
            p.moveTo(631, 348, 0.3)
            p.click()
            p.moveTo(614, 421, 0.3)
            p.click()
            p.moveTo(618, 487, 0.3)
            p.click()
            p.moveTo(602, 120, 0.3)
            p.click()
            time.sleep(2)
    closeBtn()
    time.sleep(2)
...
def vipChestOpen():
    ...
    p.click(interval=0.3)
    time.sleep(2)
    p.moveTo(240, 285, 0.3)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(388, 265, 0.3)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(566, 258, 0.3)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(227, 368, 0.3)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(391, 371, 0.3)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(580, 369, 0.3)
    p.click(interval=0.3)
    time.sleep(2)
    closeBtn()
