...
def huntChest():
    ...
    for i in range(10):
        try:
            ...
            logging.info("close btn find")
            logging.info("mouse move to point")
            p.moveTo(602, 120, 0.2)
            p.click(interval=0.3)
            p.moveTo(622, 198, 0.2)
            p.click()
            p.moveTo(610, 265, 0.2)
            p.click()
            p.moveTo(631, 348, 0.2)
            p.click()
            p.moveTo(614, 421, 0.2)
            p.click()
            p.moveTo(618, 487, 0.2)
            p.click()
            p.moveTo(602, 120, 0.2)
            p.click()
            time.sleep(2)
...
def chestOpen():
    ...
    p.moveTo(686, 387, 0.5)
    p.click()
    time.sleep(1)
    p.moveTo(432, 350, 0.5)
...
def vipChestOpen():
    ...
    questBtn()
    p.moveTo(562, 122, 0.5)
    p.click(interval=0.3)
    time.sleep(2)
    p.moveTo(240, 285, 0.5)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(388, 265, 0.5)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(566, 258, 0.5)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(227, 368, 0.5)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(391, 371, 0.5)
    p.click(interval=0.3)
    time.sleep(1)
    p.moveTo(580, 369, 0.5)
    p.click(interval=0.3)
    time.sleep(1)
    closeBtn()
...
def shelterIn():
    ...
    p.click(interval=0.3)
    time.sleep(3)
    if p.locateCenterOnScreen("c:/lod/img/close/closeShelter.png"):
        closeBtn()
        time.sleep(2)
        if p.locateCenterOnScreen("c:/lod/img/shelter/shelterRecall.png"):
            x, y = p.locateCenterOnScreen("c:/lod/img/close/closeShelter.png")
            p.moveTo(x, y, 1)
            p.click()
            time.sleep(1)
